...
import com.jaya.gd10_a_10804.databinding.ActivityFormAddMahasiswaBinding
...
class FormAddMahasiswaActivity : AppCompatActivity() {
    ...
    fun saveData(){
        with(binding) {
            ...
            RClient.instances.createData(nobp,nama,alamat,prodi,lahir).enqueue(object : retrofit2.Callback<ResponseCreate> {
