...
import com.jaya.gd10_a_10804.databinding.ActivityFormEditMahasiswaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnUpdate.setOnClickListener {
            with(binding) {
                ...
                RClient.instances.updateData(nim,nama,alamat,prodi,tgllahir).enqueue(object : retrofit2.Callback<ResponseCreate>
                {
