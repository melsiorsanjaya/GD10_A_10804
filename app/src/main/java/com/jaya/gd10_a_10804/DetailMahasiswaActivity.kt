...
import com.jaya.gd10_a_10804.databinding.ActivityDetailMahasiswaBinding
...
class DetailMahasiswaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnEdit.setOnClickListener {
            startActivity(
                Intent(this, FormEditMahasiswaActivity::class.java).apply {
                putExtra("nim",nim)
            })
        }
    }
    fun getDataDetail(nim:String){
        RClient.instances.getData(nim).enqueue(object :
            ...
            override fun onFailure(call: retrofit2.Call<ResponseDataMahasiswa>, t: Throwable) {
            }
        })
    }
...
private fun doDeleteData(nim:String) {
    RClient.instances.deleteData(nim).enqueue(object :
        ...
        override fun onFailure(call: retrofit2.Call<ResponseCreate>, t:
        Throwable) {
        }
    })
}
